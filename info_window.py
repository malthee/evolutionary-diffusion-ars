...
class InfoWindow(QMainWindow):
    def __init__(self):
        ...
        info_label.setText("""
            ...
            <p>
                All of these images you see are generated by AI, they did not exist before <b>you</b> created them. 
            
                This interactive installation showcases how evolutionary computing can be used to automatically generate images based on a score. 
