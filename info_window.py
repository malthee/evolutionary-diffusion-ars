...
class InfoWindow(QMainWindow):
    def __init__(self):
        ...
        info_label.setText("""
            ...
            <p>
                All of these images you see are generated by AI, they did not exist before <b>you</b> created them. The score you see
                is defined by an AI model that tries to predict the aesthetics of an image on a scale from 0 to 10.
            
                This interactive installation showcases how evolutionary computing can be used to steer image generation based on a score. 
                In this case, you the human play the role of the selector, deciding which images to combine, mutate and create - mimicking the process of natural selection. 
                If you like an image, you can select it and press the download button to get a QR code to download it to your device.
            </p>
           ...
           <p>
            ...
            <p>
                The image generator used here is SDXL Turbo, which is a diffusion model that uses a novel training technique to make generation much quicker (as you can see, images are generated in mere seconds). 
            </p>
            <p>
